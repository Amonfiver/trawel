...
| `wheel` (sobre el mapa) | Zoom estable centrado en el viewport; scroll de página fuera del mapa |
| click sostenido + arrastre | Pan/recolocación del mapa cuando está ampliado |

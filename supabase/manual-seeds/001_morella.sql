...
SELECT 
    ...
    'Llegar a Morella es encontrar una de las ciudades medievales mejor conservadas de España. Empieza tu visita subiendo al castillo por la mañana temprano, cuando la luz es perfecta para fotos y hay menos gente. Recorre las murallas a pie para descubrir cada torre y portal, cada uno con su historia. No te pierdas el claustro de la basílica, un oasis de paz ideal para descansar. Dedica tiempo a perderte por las calles empedradas sin rumbo fijo, que es donde encontrarás los rincones más auténticos. El museo de dinosaurios es perfecto para visitar después de comer, y si te gusta la fotografía, las vistas desde el castillo al atardecer son impresionantes.',
    'Morella es una ciudad fortificada situada en la provincia de Castellón, dentro de la comarca histórica del Maestrazgo. Su ubicación estratégica en la frontera entre Aragón y Cataluña la convirtió durante siglos en un enclave defensivo de primer orden. El conjunto amurallado, declarado Bien de Interés Cultural, conserva restos de ocupación ibérica, romana y especialmente medieval. La arquitectura civil y religiosa de los siglos XIV al XVI refleja la prosperidad que alcanzó la ciudad durante la Baja Edad Media. Geológicamente, la zona del Maestrazgo es rica en yacimientos paleontológicos del Cretácico, lo que explica la presencia de importantes restos de dinosaurios en la región.',
    '1–2 días',

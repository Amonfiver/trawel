/*
 * Migracion 016: trazabilidad editorial V2 por perfil.
 *
 * El sobre V2 de Investighost mantiene una traza raiz anclada en adventure
 * para la identidad durable de la delivery. Cada perfil conserva, dentro de
 * profiles.<mode>.metadata.investighost, su propia entrada y currentApproved.
 * Esta migracion solo cambia la proyeccion de metadata de los nuevos drafts;
 * no modifica deliveries, receipts, mappings ni borradores ya existentes.
 */
...
BEGIN
    ...
    LOOP
        ...
        ELSE
            -- Compatibilidad con payloads V2 anteriores al bloque de traza por perfil.
...
COMMENT ON FUNCTION ingest_editorial_delivery_v2(UUID, UUID, JSONB) IS 'Crea adventure y student como drafts de forma atomica; proyecta trazabilidad propia por perfil y nunca publica.';
